...
from plugins.parsers.base_parser import Document, DocumentMetadata, DocumentType, TextSegment
...
class TestStructureAwareChunker:
    ...
    def test_visual_elements_integration(self, chunker_config):
        ...
        from plugins.parsers.base_parser import VisualElement, VisualElementType
