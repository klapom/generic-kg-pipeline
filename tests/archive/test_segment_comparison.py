#!/usr/bin/env python3
"""
Generate HTML comparison of PDF pages, extracted segments, and contextual chunks
Shows the complete pipeline transformation including VLM analysis
"""
...
class SegmentComparisonGenerator:
    ...
    async def process_document(self, pdf_path: Path) -> Dict[str, Any]:
        ...
        # 1. Parse document
        parser_factory = ParserFactory(enable_vlm=False)
        document = await parser_factory.parse_document(pdf_path)
